...
# model can change  if you want and weights should change as well
...
detect = Detect(config.class_num, 0, 200, 0.01, 0.45)   #num_classes, bkg_label, top_k, conf_thresh, nms_thresh
