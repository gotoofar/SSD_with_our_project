...
pretain_model='G:/git_folder/ssd_data_and_weight/data and weight/weights/vgg16_reducedfc.pth'   #预训练模型位置
print_iter=5     #多少代打印一次信息
save_iter=200   #每多少代保存一次参数
ImageSets='G:/git_folder/ssd_data_and_weight/data and weight/VOC_stone/ImageSet/Main/train.txt'   #imageset的txt位置
rootpath='G:/git_folder/ssd_data_and_weight/data and weight/VOC_stone/'   #存放图片和标注文件的位置
